...
const Field = ({
  ...
  return (
  <div className={`cmp-mcommerce-field${className ? ` ${className}` : ""}`}>
      ...
      <main className="cmp-mcommerce checkout">
        ...
        <section className="cmp-mcommerce-panel">
          ...
          <div className="cmp-mcommerce-form-grid">
            ...
            <Field className="cmp-mcommerce-field-wide" label="Gatuadress" placeholder="Storgatan 14" value={form.address} onChange={(value) => setField("address", value)} error={customerErrors.address} required />
            <div className="cmp-mcommerce-address-row">
        ...
        <main className="cmp-mcommerce checkout">
          ...
          <section className="cmp-mcommerce-panel">
            ...
            <div
              ...
              aria-checked={terms}
              tabIndex={0}
              className={`cmp-mcommerce-check ${terms ? "on" : ""}`}
            ...
            >
              ...
              <span className="cmp-mcommerce-check-copy">
                Jag godkänner{" "}
                <button
                  type="button"
                  className="cmp-mcommerce-terms-link"
                  onClick={(event) => {
